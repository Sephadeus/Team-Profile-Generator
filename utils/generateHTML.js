...
//               </ul>
//           </section>`;
//       // console.log("This is manager html",managerHTML);
//       // return managerHTML;
//     };
...
//               <li>Role: ${engineer.getRole()}</li>
//               <li>Email: <a href="mailto:${engineer.getEmail()}">${engineer.getEmail()}</a></li>
//               <li>Github: <a href="https://github.com/${engineer.getGit()}" target="_blank">${engineer.getGit()}</a></li>
//               <li>ID: ${engineer.getID()}</li>
//           </ul>
//       </section>`;
//     };
...
//           </ul>
//       </section>`;
//       // console.log("This is intern html",internHTML);
//     };
...
//         // console.log("This is manager",managerHTML);
  
//         // console.log(page);
//       }
//       if (team[i].getRole() == "Engineer") {
//         engineerProfile(team[i]);
//         // console.log("This is engineer " , engineerHTML);
...
//         console.log("This is intern", internProfile(team[i]));
//         // console.log("This is intern",internHTML);
//         page.push(internProfile(team[i]));
